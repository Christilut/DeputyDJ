...
class Config(): # TODO concurrency
    ...
    @staticmethod
    def init_config(path, filename):
        Config.__CONFIG_FILE = path + '\\' + filename
    ...
    @staticmethod
    def set_requests_option(option, value):
        """ Set an option in the torrent section """
        Config._load_config()
        Config._set('requests', option, value)
